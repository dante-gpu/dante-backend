"""add_wallet_and_financial_fields_to_user
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('balance_dgpu', sa.Float(), nullable=False, server_default=sa.text('0.0')))
    op.add_column('users', sa.Column('total_spent', sa.Float(), nullable=False, server_default=sa.text('0.0')))
    op.add_column('users', sa.Column('total_earned', sa.Float(), nullable=False, server_default=sa.text('0.0')))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'balance_dgpu')
